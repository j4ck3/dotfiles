...
4. **Test the bootstrap script:**
   ...
   curl -fsSL -H "Cache-Control: no-cache" "https://raw.githubusercontent.com/j4ck3/dotfiles/refs/heads/master/zen/bootstrap.sh?t=$(date +%s)" | bash -s -- "YOUR-TAILSCALE-AUTH-KEY"
   ```
